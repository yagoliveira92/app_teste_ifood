...
const WeatherEntitySchema = Schema(
...
void _weatherEntitySerialize(
  ...
  writer.writeString(offsets[4], object.main);
...
WeatherEntity _weatherEntityDeserialize(
  ...
  final object = WeatherEntity(
    ...
    main: reader.readStringOrNull(offsets[4]),
  );
  return object;
}
...
extension WeatherEntityQueryFilter
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> iconEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> iconBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> iconMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> mainEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> mainBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WeatherEntity, WeatherEntity, QAfterFilterCondition> mainMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
